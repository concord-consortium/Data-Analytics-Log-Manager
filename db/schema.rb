...
ActiveRecord::Schema.define(version: 20180223012122) do
  ...
  add_index "logs", ["run_remote_endpoint"], name: "index_logs_on_run_remote_endpoint", where: "(run_remote_endpoint IS NOT NULL)", using: :btree
